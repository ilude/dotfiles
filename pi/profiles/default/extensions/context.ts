// Ported from the legacy /context report. Component counts are character estimates,
// not a provider tokenizer or an inspection of the final serialized request.
