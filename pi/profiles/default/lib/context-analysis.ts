// Character-based component estimates, not provider tokenization.
import { formatSkillsForPrompt, type Skill } from "@earendil-works/pi-coding-agent";
export const CONTEXT_REPORT_MESSAGE_TYPE = "context-report";
...
export function hasProviderBasedContextUsage(branch: AnyEntry[]): boolean {
	let startIndex = 0;
...
export function collectSessionUsage(entries: AnyEntry[]) {
	let input = 0;
	let output = 0;
	let cacheRead = 0;
	let cacheWrite = 0;
