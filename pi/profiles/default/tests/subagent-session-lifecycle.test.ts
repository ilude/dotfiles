...
export default function(pi) {
 ...
 const args = {agent:'explorer',instructions:${JSON.stringify(`WAIT_FILE:${release}`)},cwd:${JSON.stringify(scratch)},model:'subagent-fixture/inert',effort:'low',skills:[],background:true,blockingReason:'The replacement result is required before continuing.',retain:false,surface:'headless'};
