...
7. **Validate and report.** Test required inclusion, unrelated exclusion, audience routing, deterministic composition, and justified size bounds. Use representative behavior checks when they can resolve consequential uncertainty. Report which requirements were preserved, relocated, consolidated, or removed, and distinguish prompt-loading tests, provider measurements, and model-adherence evidence.
