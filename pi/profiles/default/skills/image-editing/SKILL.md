---
name: image-editing
description: "Safely crop, resize, rotate, auto-orient, convert, or compress local images."
---
...
1. Before any crop or pixel-coordinate transform, call `image_properties` and use its dimensions, orientation, and metadata.
