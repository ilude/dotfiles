...
SHARDS: list[tuple[str, Path]] = [
    ...
    ("realClaude", DATA / "synthetic_shards" / "realClaude" / "chunk.sonnetPlus.jsonl"),
    ("realPi", DATA / "synthetic_shards" / "realPi" / "chunk.sonnetPlus.jsonl"),
]
...
def main() -> int:
    ...
    lines.append("|-------|------|-------|")
    lines.append("| genA  | data/synthetic_shards/genA/chunk.jsonl | mini + core-low |")
    lines.append("| genB  | data/synthetic_shards/genB/chunk.jsonl | core-medium |")
    lines.append("| genC  | data/synthetic_shards/genC/chunk.jsonl | core-high + large-low |")
    lines.append("| genD  | data/synthetic_shards/genD/chunk.jsonl | large-medium/high |")
    lines.append("")
