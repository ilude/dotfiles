...
out.append('        f.write(row(f\'GD-OH-{i:04d}\', f\'GD-F-OH-{i:04d}\', prompt, domain, task_type, ambiguity, \'large\', \'high\', complexity_tier) + \'\\n\')\n')
out.append('        total += 1\n')
out.append('    for i, (prompt, domain, task_type, ambiguity, complexity_tier) in enumerate(opus_medium):\n')
out.append('        f.write(row(f\'GD-OM-{i:04d}\', f\'GD-F-OM-{i:04d}\', prompt, domain, task_type, ambiguity, \'large\', \'medium\', complexity_tier) + \'\\n\')\n')
out.append('        total += 1\n')
out.append('    for i, (prompt, domain, task_type, ambiguity, complexity_tier) in enumerate(sonnet_high):\n')
out.append('        f.write(row(f\'GD-SH-{i:04d}\', f\'GD-F-SH-{i:04d}\', prompt, domain, task_type, ambiguity, \'core\', \'high\', complexity_tier) + \'\\n\')\n')
out.append('        total += 1\n')
out.append('\n')
