...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		promptGuidelines: [
			"Never use subagent_status to poll a subagent's work progress. Wait for pushed completion, timeout, or watchdog events instead.",
			"Use subagent_status only for exceptional diagnosis when a timeout, watchdog event, or other direct evidence requires current process information.",
