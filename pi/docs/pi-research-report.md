...
| Automatic advisory or analytical | Friction metadata collection and selected detached review run after their predicates; worktree occupancy supplies an advisory warning rather than a mutation block. [SRC-020; SRC-021; SRC-027] |
...
| SRC-027 | Tracked source, current | `pi/extensions/agent-instances.ts:92-146` | Baseline commit | Advisory worktree occupancy | No lease records | Warning is nonblocking |
