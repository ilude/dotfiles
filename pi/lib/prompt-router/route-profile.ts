...
> = {
	nano: {
		...
		preferredModels: ["gpt-5.6-luna", "gpt-5.4-nano"],
		routeState: "disabled",
		fallbackRoute: "mini",
	...
	mini: {
		...
		profile: "codex:mini",
		provider: "openai-codex",
		preferredModels: ["gpt-5.6-luna", "gpt-5.4-mini"],
	...
	core: {
		...
		profile: "codex:core",
		provider: "openai-codex",
		preferredModels: ["gpt-5.6-terra", "gpt-5.5", "gpt-5.3-codex"],
		routeState: "available",
		trustClass: "same-family",
	},
	large: {
		...
		profile: "codex:large",
		provider: "openai-codex",
		preferredModels: ["gpt-5.6-sol", "gpt-5.5", "gpt-5.3-codex"],
		routeState: "available",
		trustClass: "same-family",
	},
	max: {
