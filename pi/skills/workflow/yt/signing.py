"""HTTP request signing for menos API."""
...
class RequestSigner:
    ...
    def sign_request(
        ...
        content_digest = None
        if body:
            digest_b64 = b64encode(hashlib.sha256(body).digest()).decode()
        ...
        signature_base = "\n".join(lines)
        signature_b64 = b64encode(self.private_key.sign(signature_base.encode())).decode()
