...
- Closeout: archive the canonical spec, commit the archive and in-scope artifacts, then verify final HEAD and a clean worktree before clearing unattended state.
