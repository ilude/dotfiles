...
- Text operations: support literal replacement, regular-expression replacement, line-ending normalization, and final-newline enforcement. Validate operation shape and expected match counts before writing.
