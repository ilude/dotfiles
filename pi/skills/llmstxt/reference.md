...
A markdown file at `/llms.txt` that helps LLMs efficiently understand and navigate website content. Unlike robots.txt (crawling) or sitemap.xml (indexing), llms.txt targets **inference-time usage** - helping LLM tools use your documentation.
...
- Test with multiple LLM tools when practical
