...
- [Damage-Control Hooks - Gap Analysis & Missing Attack Mitigations](../projects/pi-damage-control-gap-analysis.md)
...
If pursued, begin with one bounded source-to-sink `mktemp` cleanup pattern that fails closed on ambiguity and has positive and bypass fixtures.
