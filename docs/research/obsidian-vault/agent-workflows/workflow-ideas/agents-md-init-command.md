...
Keep any `/init` implementation conservative: derive a short marked section from repository evidence, preserve authored content, and ask only when policy cannot be inferred.
