...
See also: [Deterministic agent rules and guardrails](../patterns/deterministic-agent-rules-and-guardrails.md)

## KISS recommendation

Use the open skill format and existing validators, then add one narrowly scoped skill only when repeated workflow pain justifies it.
