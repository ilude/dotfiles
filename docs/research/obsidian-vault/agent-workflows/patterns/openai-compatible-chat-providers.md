...
Keep one small OpenAI-compatible chat contract with explicit provider defaults and tolerant error parsing; add provider branches only when observed behavior requires them.
