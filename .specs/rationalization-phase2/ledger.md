...
| Naive shell argv classification | Shell leaders hide the command rule | `.specs/rationalization-phase2/plan.md` corpus baseline | 47.88% unmatched at baseline | Keep partial; gate blocked | Fallback normalization preserved existing matches and raised replay from 52.12% to 59.48% with 2,367 new matches. This is below 65%; residual top ten: python 2010, sed 1320, git 1247, head 962, true 855, tee 522, pnpm 442, uv 366, tail 355, echo 300. Failure-survival failures: 0; guard fallbacks: 152. | T8 | Implemented, threshold not met |
