...
- Completion classification: superseded-by-v2.
...
- Next wave/gate to run: none; archived as superseded by prompt-router-control-plane-v2 after provider-seam implementation merged to main.
...
- Archive decision: archived as superseded. Required same-turn proof failed for the input-hook architecture; V2/provider-seam implementation superseded this plan and is merged to main.
- Commands run:
