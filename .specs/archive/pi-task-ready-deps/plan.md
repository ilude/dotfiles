...
- [x] P0: Preflight dependency UX inventory
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/P0-preflight.md`
- [x] V0: Validate preflight findings
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/V0-preflight-validation.md`

### Wave 1

- [x] T1: Add dependency readiness helpers
  - Status: completed
  - Evidence: `pi/lib/task-registry.ts`, `pi/tests/task-dependencies.test.ts`; targeted tests passed in V1
- [x] T2: Upgrade task renderer for ready/waiting dependency display
  - Status: completed
  - Evidence: `pi/lib/task-renderer.ts`, `pi/tests/task-renderer.test.ts`; targeted tests passed in V1
- [x] V1: Validate dependency helper and renderer behavior
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/V1-focused-validation.md`

### Wave 2

- [x] T3: Add `/tasks ready` and `/tasks blocked` commands
  - Status: completed
  - Evidence: `pi/extensions/tasks.ts`, `pi/tests/tasks.test.ts`; registered command tests passed in V1
- [x] T4: Enforce unmet dependencies on `/tasks start`
  - Status: completed
  - Evidence: `pi/extensions/tasks.ts`, `pi/tests/tasks.test.ts`; registered command tests passed in V1
- [x] V2: Validate command behavior
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/V2-command-validation.md`

### Wave 3

- [x] T5: Document Option 2 and Option 3 follow-up architecture
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/T5-follow-up-architecture.md`
- [x] V3: Validate docs and integration scope
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/V3-docs-validation.md`

### Final Gates

- [x] F1: Task-specific verification complete
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/F1-task-specific-verification.md`
- [x] F2: Repo-wide validation complete
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/F2-repo-validation.md`
- [x] F3: Manual validation not required
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/F3-manual-not-required.md`
- [x] F4: Deployment validation not required
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/F4-deployment-not-required.md`
- [x] F5: Archive preflight complete
  - Status: completed
  - Evidence: `.specs/pi-task-ready-deps/evidence/F5-archive-preflight.md`
