...
- [ ] T3: cross-client worktree occupancy leases - in-progress: wire Claude lifecycle and status
...
- **Next:** T3, wire Claude lifecycle hooks and status line to the shared helper, then run cross-client fixtures
