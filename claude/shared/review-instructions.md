...
- During auto-detection, exclude nested project trees/submodules (for example, `modules/onclave/.specs/**`) unless the user explicitly asks for cross-project search.
