---
name: prd-generator
description: Convert a rough MVP idea into a demo-grade PRD (Product Requirements Document). Activate when user describes a feature idea, MVP concept, or demo they want to build.
location: user
...
**Write the PRD to a file** (e.g., `PRD.md` or `{feature-name}-prd.md`) in the project directory.
...
After generating the PRD, suggest running the `prd-to-ux` skill to translate it into a UX specification.
