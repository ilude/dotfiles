...
- [REST Patterns](references/rest-patterns.md) - Resource naming, HTTP methods, status codes, versioning, pagination
- [GraphQL Patterns](references/graphql-patterns.md) - Schema design, queries, mutations, resolvers, N+1 prevention
- [Auth Patterns](references/auth-patterns.md) - API keys, JWT, OAuth2, permission models (RBAC/ABAC)
