...
Guidelines for optimizing Claude rulesets and instruction files (CLAUDE.md, settings.json) using context efficiency principles.
...
**Formula:** `tokens x (1 - usage_frequency)`
