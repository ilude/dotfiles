---
name: database
description: Database design, SQL, ORM patterns, migrations, and optimization. Activate when working with SQL files, database schemas, or discussing database patterns.
---
...
- **SQL Workflow** - [sql.md](sql.md)
- **Migration Patterns** - [migration-patterns.md](migration-patterns.md)
- **ORM Patterns** - [orm-patterns.md](orm-patterns.md)
- **SQL Optimization** - [sql-optimization.md](sql-optimization.md)
