...
**Auto-activate when:** Working with `Dockerfile`, `docker-compose.yml`, `.dockerignore`, Kubernetes manifests, or when user mentions Docker, containers, or deployment workflows.

**See also:** [DevContainer Configuration](./devcontainer.md) for VS Code DevContainers
