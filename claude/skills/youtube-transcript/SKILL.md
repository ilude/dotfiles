...
description: "YouTube transcript and metadata fetching with proxy support. Activate when working with YouTube transcripts, metadata, video descriptions, URLs from videos, youtube-transcript-api, or YouTube Data API v3."
---

# YouTube Data Fetching Skill

Fetch YouTube transcripts and metadata with proxy support. Two scripts:
...
```
--json                Output as JSON
--urls-only           Only print URLs from description
--description-only    Only print description
```
