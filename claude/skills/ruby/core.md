...
Testing rules are automatically loaded when working with test files. For comprehensive RSpec and Minitest patterns see [testing.md](testing.md).
...
- Rails projects: [rails.md](rails.md)
- Hanami projects: [hanami.md](hanami.md)
