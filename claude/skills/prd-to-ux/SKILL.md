---
name: prd-to-ux
description: Translate PRDs, feature specs, or product requirements into UX specifications through 6 forced designer mindset passes. Use before creating visual designs, wireframes, or component specs.
location: user
...
After generating the UX spec, suggest running the `ux-to-build-prompts` skill to create sequenced build prompts for UI generation tools.
