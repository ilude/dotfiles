...
description: Structured debugging methodology. Activate when encountering errors, test failures, or unexpected behavior. Prevents random fix attempts and ensures root cause analysis.
---
