...
- **Fix ALL errors and warnings** - Never dismiss as pre-existing or unrelated. Warnings have the same urgency as errors.
...
- **No validation phrases** - When wrong, state the error and fix. No "You're absolutely right!", "Great question!", or similar deflection.
- **Ask, don't assume** - Never guess or fill in blanks. Ask clarifying questions.
- **AskUserQuestion** - Always use this tool for questions. Use multiSelect: true for multiple related questions.
- **1-3-1 Rule** - When stuck, provide 1 clearly defined problem, give 3 potential options, and 1 recommendation. Do not proceed until I confirm.
