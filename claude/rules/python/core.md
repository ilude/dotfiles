...
Testing rules are automatically loaded when working with test files. For comprehensive pytest patterns see @~/.claude/rules/python/testing.md
...
- Django projects: @~/.claude/rules/python/frameworks/django.md
- FastAPI projects: @~/.claude/rules/python/frameworks/fastapi.md
- Flask projects: @~/.claude/rules/python/frameworks/flask.md
